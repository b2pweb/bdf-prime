...
final class Query
{
    public function getFromRepository(): void
    {
        ...
        $this->checkPersonNotNull(Person::repository()->findByIdOrFail('123'));
        $this->checkPersonNotNull(Person::repository()->findByIdOrFail('123'));
    }
    ...
    public function getFromStaticCall(): void
    {
        ...
        $this->checkPersonNotNull(Person::findByIdOrFail('123'));
        $this->checkPersonNotNull(Person::findByIdOrNew('123'));
    }
    ...
    public function test_relation(): void
    {
        ...
        $relation = Person::findByIdOrFail(123)->relation('address');
    ...
    {
        $relation = Person::findByIdOrFail(123)->relation(Address::class);
