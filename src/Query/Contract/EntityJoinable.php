...
interface EntityJoinable extends Joinable, Whereable
{
     ...
     */
    public function joinEntity(string $entity, string|callable $key, ?string $foreign = null, ?string $alias = null, string $type = self::INNER_JOIN);
     ...
     * @return $this This Query instance.
     */
    public function leftJoinEntity(string $entity, string|callable $key, ?string $foreign = null, ?string $alias = null);
     ...
     * @return $this This Query instance.
     */
    public function rightJoinEntity(string $entity, string|callable $key, ?string $foreign = null, ?string $alias = null);
}
